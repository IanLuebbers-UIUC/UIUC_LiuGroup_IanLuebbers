...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
  ...
  G4Material* default_mat = nist->FindOrBuildMaterial("Galactic");
  ...
  auto solidDet = new G4Tubs("solidDet", 0, (8/2)*cm, (9/2)*cm, 0*deg, 360*deg);
  auto logicDet = new G4LogicalVolume(solidDet, cryst_mat, "CrystalLV");
  G4VPhysicalVolume *physDet = new G4PVPlacement(0, G4ThreeVector(0, 0, (20+9/2)*cm), logicDet, "Detector", logicWorld, false, 0, false);

  //Dead-Layer
  G4double DL_length = 500*um;
  
  auto solidDL = new G4Tubs("solidDL", 0, (8/2)*cm, DL_length/2, 0*deg, 360*deg);
  auto logicDL = new G4LogicalVolume(solidDL, cryst_mat, "logicDL");
  G4VPhysicalVolume *physDL = new G4PVPlacement(0, G4ThreeVector(0, 0, (20*cm-DL_length/2)), logicDL, "DeadLayer", logicWorld, false, 0, false);
  ...
  G4Material* patient_mat = nist->FindOrBuildMaterial("Galactic");
