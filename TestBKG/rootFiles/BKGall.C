...
//Read Data from TFile
	//No Shield Variables
	TFile *input1 = new TFile("TestBKG_NoShield.root", "read");
	...
	//Cu Shield Variables
        TFile *input2 = new TFile("TestBKG_CuShield.root", "read");
	...
	//All Shield Variables
        TFile *input3 = new TFile("TestBKG_FullShield.root", "read");
...
//Graph the data
	...
	//No Shield
        TH1F *hist1 = new TH1F("hist1", Title, 1000, 0 , 1.5);
	...
	//Cu Shield Only
        TH1F *hist2 = new TH1F("hist2", Title, 1000, 0 , 1.5);
        for(int i = 0; i < entries2; i++)
        {
                tree2->GetEntry(i);
                hist2->Fill(fEdep_HPGe2);
        }
        hist2->SetLineColorAlpha(kGreen, 0.35);
	...
	//All Sheilds
        TH1F *hist3 = new TH1F("hist3", Title, 1000, 0 , 1.5);
	...
	leg->AddEntry(hist1, "No Shielding", "l");
        leg->AddEntry(hist2, "Cu Shielding", "l");
        leg->AddEntry(hist3, "Cu + Pb Shielding", "l");
	leg->Draw();

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
//Print the Graph
        TString GraphName = "BackgroundAllShield.pdf";
