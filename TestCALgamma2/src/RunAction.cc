...
//  man->SetNtupleMerging(true);
  ...
  man->CreateNtuple("Kinematics","Kinematics");
...
void RunAction::BeginOfRunAction(const G4Run* run/*, DetectorConstruction &DCobj*/)
{ 
  // keep run condition
  if (fPrimary) { 
...
//  G4String ThicknessName = to_string(len);
  ...
  //Specify Detector Geometry here, if desired
  ...
  man->OpenFile("../rootFiles/d" + DiameterName + "z" + ThicknessName + "/TestCAL" + strRunID.str() + ".root");
